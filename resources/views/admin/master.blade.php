...
<head>
    ...
    <title>SACHVIETNAM - @yield('module', 'Dashboard') @yield('action')</title>
...
<body>
    ...
    <div class="sidebar">
            ...
            <ul class="sidebar__nav">
                ...
                <li class="sidebar__nav-item">
                    <a class="sidebar__nav-link" data-toggle="collapse" href="#collapseMenu1" role="button"
                        ...
                        <i class="icon ion-ios-book"></i> <span>book</span> <i class="icon ion-md-arrow-dropdown"></i>
                    </a>
                    <ul class="collapse sidebar__menu" id="collapseMenu1">
                        <li><a href="{{ route('admin.book.index') }}">Manage</a></li>
                        <li><a href="{{ route('admin.book.create') }}">Add book</a></li>
                    </ul>
                </li>
                <!-- end collapse -->
                ...
                <li class="sidebar__nav-item">
                    <a href="{{ route('index') }}" class="sidebar__nav-link"><i
                            class="icon ion-ios-arrow-round-back"></i> <span>Back to SACHVIETNAM</span></a>
                </li>
            </ul>
        </div>
        <!-- end sidebar nav -->
        ...
        <!-- sidebar copyright -->
        <div class="sidebar__copyright">© SACHVIETNAM, 2020—2022. <br>Create by <a
                href="https://www.facebook.com/profile.php?id=100010833308435" target="_blank">Tĩnh & Pháp</a></div>
